...
Route::prefix('admin/laporan')->name('admin.laporan.')->group(function () {
    ...
    Route::get('/pendapatan-usaha', [LaporanController::class, 'pendapatanUsaha'])->name('pendapatanUsaha');
    Route::get('/produk-terlaris', [LaporanController::class, 'produkTerlaris'])->name('produkTerlaris');
    Route::get('/produk-slow-moving', [LaporanController::class, 'produkSlowMoving'])->name('produkSlowMoving');
    Route::get('/transaksi-user', [LaporanController::class, 'transaksiUser'])->name('transaksiUser');
    Route::get('/kategori-produk', [LaporanController::class, 'kategoriProduk'])->name('kategoriProduk');

    // EXPORT DASHBOARD/LAPORAN (DISESUAIKAN DENGAN NAMA METODE DI CONTROLLER)
    Route::get('/export/pdf', [LaporanController::class, 'transaksiExportPdf'])
        ->name('export.pdf');   // => admin.laporan.export.pdf

    Route::get('/export/excel', [LaporanController::class, 'transaksiExportExcel'])
        ->name('export.excel'); // => admin.laporan.export.excel

    // Laporan produk favorite & views
    Route::get('/produk-favorite', [LaporanController::class, 'produkFavorite'])
        ->name('produkFavorite');  // admin.laporan.produkFavorite
    Route::get('/produk-views', [LaporanController::class, 'produkViews'])
        ->name('produkViews');     // admin.laporan.produkViews
